...
class Footer extends Component {
  constructor() {
    ...
    <FlexView id="footer_background" column style={styles.footer1_root}>
      <FlexView id="leftsection" basis="100%" vAlignContent="center" hAlignContent='left'>
                ...
                <FlexView id="middlesection" basis="50%" hAlignContent="center" vAlignContent="center">
                  <Copyright style={styles.copyright_icon} />

                        <Typography type="body1" color="default" align="center" style={{marginLeft:6}}>
                        Referix 2018
                        </Typography>
                </FlexView>
